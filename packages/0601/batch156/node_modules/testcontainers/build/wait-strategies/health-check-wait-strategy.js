...
class HealthCheckWaitStrategy extends wait_strategy_1.AbstractWaitStrategy {
    async waitUntilReady(container) {
        ...
        const status = await new common_1.IntervalRetry(100).retryUntil(async () => (0, health_check_1.getHealthCheckStatusFromInspect)(await client.container.inspect(container)), (healthCheckStatus) => healthCheckStatus === "healthy" || healthCheckStatus === "unhealthy", () => {

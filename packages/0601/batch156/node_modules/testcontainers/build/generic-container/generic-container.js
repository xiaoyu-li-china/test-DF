...
const wait_strategy_selector_1 = require("../wait-strategies/utils/wait-strategy-selector");
...
class GenericContainer {
    ...
    constructor(image) {
        ...
        this.hostConfig = { AutoRemove: this.imageName.string === (0, reaper_1.getReaperImage)() };
    }
    isHelperContainer() {
        return this.isReaper() || this.imageName.string === port_forwarder_1.SSHD_IMAGE;
    }
    isReaper() {
        return this.imageName.string === (0, reaper_1.getReaperImage)();
    }
    async start() {
    ...
    async selectWaitStrategy(client, inspectResult, waitStrategy = this.waitStrategy) {
        return (0, wait_strategy_selector_1.selectWaitStrategy)({
            client,
            inspectResult,
            waitStrategy,
    ...
    async reuseContainer(client, container) {
        ...
        return new started_generic_container_1.StartedGenericContainer(container, client.info.containerRuntime.host, inspectResult, boundPorts, inspectResult.Name, waitStrategy, this.autoRemove);
    }
    async startContainer(client) {
        ...
        await (0, wait_for_container_1.waitForContainer)(client, container, waitStrategy, boundPorts);
        const startedContainer = new started_generic_container_1.StartedGenericContainer(container, client.info.containerRuntime.host, inspectResult, boundPorts, inspectResult.Name, waitStrategy, this.autoRemove);

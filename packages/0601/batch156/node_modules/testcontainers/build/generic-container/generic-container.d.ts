import { ContainerCreateOptions, ContainerInspectInfo, HostConfig } from "dockerode";
...
export declare class GenericContainer implements TestContainer {
    ...
    protected selectWaitStrategy(client: ContainerRuntimeClient, inspectResult: ContainerInspectInfo, waitStrategy?: WaitStrategy | undefined): Promise<WaitStrategy>;

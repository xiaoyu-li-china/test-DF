...
exports.getMonthlyReport = exports.MOCK_STORE_RANKINGS = exports.MOCK_INSPECTIONS = exports.MOCK_INSPECTOR = exports.MOCK_STORES = void 0;
...
const generateMockInspections = () => {
    ...
    const stores = exports.MOCK_STORES.slice(0, 5);
    stores.forEach((store, index) => {
        ...
        inspections.push({
            ...
            inspectorId: exports.MOCK_INSPECTOR.id,
            inspectorName: exports.MOCK_INSPECTOR.name,
            ...
            totalScore: score,
            maxScore,
            categories: constants_1.INSPECTION_CATEGORIES,
            scores: [],
            photos: [],
...
exports.MOCK_INSPECTIONS = generateMockInspections();
exports.MOCK_STORE_RANKINGS = [
...
const getMonthlyReport = (month) => {
    return {
        ...
        averageScore: 87.5,
        passRate: 92.5,
        storeRankings: exports.MOCK_STORE_RANKINGS,
        areaStatistics: [

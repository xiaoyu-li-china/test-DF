...
export const hasPermission = (
  userRole: UserRole, resource: string, action: string): boolean => {
...
export const canAccessArea = (userAreas: string[], targetArea: string): boolean => {
  if (userAreas.includes('*')) return true;

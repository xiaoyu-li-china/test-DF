...
import { Store, Inspector, Inspection, InspectionStatus, StoreRanking, MonthlyReport } from '../types';
...
export const MOCK_INSPECTOR: Inspector = {
  id: 'i001',
  name: '王督导',
  role: 'inspector',
  phone: '13900139001',
...
const generateMockInspections = (): Inspection[] => {
  ...
  const statuses: InspectionStatus[] = ['pending', 'in_progress', 'completed', 'pending', 'pending'];
